...
<section class=" max-w-[1000px] mx-auto bg-gray-100">
      ...
      <h1 class=" text-center font-serif font-bold text-3xl bg-fuchsia-200 p-2">Create Course</h1>
      <form action="./course-save.php" method="post" class=" bg-gray-200">
            <div class=" grid grid-cols-3 gap-3  p-3">
                  ...
                  <div class=" col-span-1">
                        <input type="number" name="fee" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="fee">
      ...
      <h1 class=" font-serif font-semibold text-center text-2xl text-decoration-underline ">Course Lists</h1>
                        ...
                        <div class="overflow-hidden">
                              <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                    ...
                                    <tbody>
                                          ...
                                          $sql = "SELECT *, (SELECT count(id) FROM batches WHERE courses.id = batches.course_id) AS batch_count  from courses";
                                          ...
                                          <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                                                <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-neutral-900 dark:even:bg-neutral-800">
                                                      ...
                                                      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-neutral-200"><?= $row['title'] ?></td>
