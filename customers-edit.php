...
<section class=" max-w-[1000px] mx-auto bg-gray-100">
      <ol class="flex items-center whitespace-nowrap">
            ...
            <li class="inline-flex items-center">
                  <a class="flex items-center text-sm text-gray-500 hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500" href="./customers-edit.php">
                        Customer Edit
                  </a>
      ...
      <h1 class=" text-center font-serif font-bold text-3xl bg-fuchsia-200 p-2">Edit Customer</h1>
      <?php
            ...
            <div class=" grid grid-cols-2 gap-3 mt-2">
                  ...
                  <div class=" col-span-1">
                        <div class="max-w-sm space-y-3">
                              <input name=" name" type="text" value="<?= $row['name'] ?>" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Enter your name">
                        </div>
                  </div>
                  <div class=" col-span-1">
                        <div class="max-w-sm space-y-3">
                              <input name=" phone" type="number" value="<?= $row['phone'] ?>" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Enter your phone number">
                        </div>
                  </div>
